...
| 118 | Pascal's Triangle | O(n*n) | O(n) | [python](leetcode/easy/118.%20Pascal%27s%20Triangle.py) | [leetcode.com](https://leetcode.com/problems/pascals-triangle) |
| 119 | Pascal's Triangle II | O(n*n) | O(n) | [python](leetcode/easy/119.%20Pascal%27s%20Triangle%20II.py) | [leetcode.com](https://leetcode.com/problems/pascals-triangle-ii/) |
...
| 401 | Binary Watch | O(1) | O(1) | [python](leetcode/easy/401.%20Binary%20Watch.py) | [leetcode.com](https://leetcode.com/problems/binary-watch/) |
...
| 868 | Binary Gap | O(log n) | O(1) | [python](leetcode/easy/868.%20Binary%20Gap.py) | [leetcode.com](https://leetcode.com/problems/binary-gap/) |
...
| 944 | Delete Columns to Make Sorted | O(n*m) | O(1) | [python](leetcode/easy/944.%20Delete%20Columns%20to%20Make%20Sorted.py) | [leetcode.com](https://leetcode.com/problems/delete-columns-to-make-sorted/) |
| 961 | N-Repeated Element in Size 2N Array | O(n) | O(n) | [python](leetcode/easy/961.%20N-Repeated%20Element%20in%20Size%202N%20Array.py) | [leetcode.com](https://leetcode.com/problems/n-repeated-element-in-size-2n-array/) |
...
| 2273 | Find Resultant Array After Removing Anagrams | O(n*m) | O(n*m) | [python](leetcode/easy/2273.%20Find%20Resultant%20Array%20After%20Removing%20Anagrams.py) | [leetcode.com](https://leetcode.com/problems/find-resultant-array-after-removing-anagrams/) |
...
| 3005 | Count Elements With Maximum Frequency | O(n) | O(m) | [python](leetcode/easy/3005.%20Count%20Elements%20With%20Maximum%20Frequency.py) | [leetcode.com](https://leetcode.com/problems/count-elements-with-maximum-frequency/) |
...
| 3074 | Apple Redistribution into Boxes | O(m + n log n) | O(1) | [python](leetcode/easy/3074.%20Apple%20Redistribution%20into%20Boxes.py) | [leetcode.com](https://leetcode.com/problems/apple-redistribution-into-boxes/) |
...
| 3289 | The Two Sneaky Numbers of Digitville | O(n) | O(n) | [python](leetcode/easy/3289.%20The%20Two%20Sneaky%20Numbers%20of%20Digitville.py) | [leetcode.com](https://leetcode.com/problems/the-two-sneaky-numbers-of-digitville/) |
...
| 3370 | Smallest Number With All Set Bits | O(log n) | O(1) | [python](leetcode/easy/3370.%20Smallest%20Number%20With%20All%20Set%20Bits.py) | [leetcode.com](https://leetcode.com/problems/smallest-number-with-all-set-bits/) |
...
| 3461 | Check If Digits Are Equal in String After Operations I | O(n*n) | O(n) | [python](leetcode/easy/3461.%20Check%20If%20Digits%20Are%20Equal%20in%20String%20After%20Operations%20I.py) | [leetcode.com](https://leetcode.com/problems/check-if-digits-are-equal-in-string-after-operations-i/) |
...
| 1458 | Max Dot Product of Two Subsequences | O(n*m) | O(m) | [python](leetcode/hard/1458.%20Max%20Dot%20Product%20of%20Two%20Subsequences.py) | [leetcode.com](https://leetcode.com/problems/max-dot-product-of-two-subsequences) |
...
| 1382 | Balance a Binary Search Tree | O(n) | O(n) | [python](leetcode/medium/1382.%20Balance%20a%20Binary%20Search%20Tree.py) | [leetcode.com](https://leetcode.com/problems/balance-a-binary-search-tree/) |
...
| 2211 | Count Collisions on a Road | O(n) | O(n) | [python](leetcode/medium/2211.%20Count%20Collisions%20on%20a%20Road.py) | [leetcode.com](https://leetcode.com/problems/count-collisions-on-a-road) |
| 2221 | Find Triangular Sum of an Array | O(n*n) | O(n) | [python](leetcode/medium/2221.%20Find%20Triangular%20Sum%20of%20an%20Array.py) | [leetcode.com](https://leetcode.com/problems/find-triangular-sum-of-an-array/) |
| 2257 | Count Unguarded Cells in the Grid | O(m*n) | O(m*n) | [python](leetcode/medium/2257.%20Count%20Unguarded%20Cells%20in%20the%20Grid.py) | [leetcode.com](https://leetcode.com/problems/count-unguarded-cells-in-the-grid/) |
...
| 3186 | Maximum Total Damage With Spell Casting | O(n log n) | O(n) | [python](leetcode/medium/3186.%20Maximum%20Total%20Damage%20With%20Spell%20Casting.py) | [leetcode.com](https://leetcode.com/problems/maximum-total-damage-with-spell-casting/) |
...
| 3346 | Maximum Frequency of an Element After Performing Operations I | O(n log n) | O(n) | [python](leetcode/medium/3346.%20Maximum%20Frequency%20of%20an%20Element%20After%20Performing%20Operations%20I.py) | [leetcode.com](https://leetcode.com/problems/maximum-frequency-of-an-element-after-performing-operations-i/) |
